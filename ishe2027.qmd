...
subtitle: "ISHE Summer Institute 2027"
format:
  revealjs:
    ...
    footer: "ISHE Summer Institute 2027 · Bogotá, Colombia"
    progress: true
    controls: true
    history: true
    width: 1280
...
That solves the iframe issue completely — served over HTTPS, browsers will have no problem with the YouTube embeds.

A few things worth setting up for GitHub Pages while you're at it. Add these to your YAML header if they're not already there:
...
[Colombia: a multi-ethnic and multicultural country ↗](https://www.colombia.co/en/colombia-country/colombia-multi-ethnic-multicultural-country/){target="_blank"}
:::
:::
:::
::::
...
- Hundreds of restaurants, bars, and cafés
...
[Best restaurants ↗](https://www.eater.com/maps/best-bogota-restaurants){target="_blank"}
:::
:::
:::
::::
